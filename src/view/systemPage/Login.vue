        ...
        <el-form :model="loginForm" :rules="rules" ref="loginForm">
          ...
          <div class="loginFormItem">
            <el-form-item prop="loginWay">
              <el-select v-model="loginForm.loginWay" placeholder="请选择登录方式" style="width: 100%">
                <el-option
          ...
          <div class="loginFormItem">
            <el-form-item prop="loginAccount">
              <el-input class="loginIpt" placeholder="登录账号" v-model="loginForm.loginAccount"></el-input>
            </el-form-item>
          </div>
          <div class="loginFormItem">
